...
public class UserController {
    ...
    @PostMapping("add")
    public String addProductToBd(
            //Запрашиваемые параметры при добавлении нового товара
        ...
        if (bindingResult.hasErrors()) {
            ...
            //Если загружаемый файл не смог быть загружен,
            // пользователя вернет обратно на страницу добавления нового товара
            return "admin/addToDb";
        } else {
            // Сохраняем файл (картинку товара)
            saveFile(good, file);
            ...
            log.debug("ADMIN={} added product to DB: id={}, producer={}, good={}",
                    user.getUsername(), good.getId(), good.getProducer(), good.getTitle());
        }
