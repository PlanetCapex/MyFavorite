...
public class MainController {
    ...
    public String search(
        ...
        // Создаем новый объект страницы
        // Используем функцию нахождения товаров по ключевому слову
        Page<Good> page = goodService.findByKeyword(keyword.toLowerCase(), pageable);
        // Рассчитываем количество необходимых страниц для отображение товаров
        int[] pagination = ControllerUtils.computePagination(page);

        // Передаем необходимую информацию для отоброжения пользователю
